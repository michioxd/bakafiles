...
File: first_setup.php
*/
if (isset($_POST['login_index'])) {
  $login__username = filter_var(strip_tags($_POST['u_name']), FILTER_SANITIZE_STRING);
  $login__password = filter_var(strip_tags($_POST['u_pass']), FILTER_SANITIZE_STRING);
  if (empty($login__password) or empty($login__password)) {
    $_login_error = "Username or password can't empty";
  } else {
    $data = '
//generated by first_setup.php
$SS_USERNAME = "' . $login__username . '";
$SS_PASSWORD = "' . $login__password . '";
';
    $load__config_file = fopen(__DIR__ . "/../../../bakafiles-this_is-your_config.php", "a");
    fwrite($load__config_file, $data);
    fclose($load__config_file);
...
<body>
  <div class="section-login mdl-card mdl-shadow--2dp">
    <div class="section-splash-login" style="text-align: center;">
      <h4>Hello!</h4>
      <p>Welcome to bakafiles~</p>
      <p>Now create your account to contiune :3</p>
    </div>
